...
from InsurancePremiumPrediction.logger import logging, get_log_file_name
from InsurancePremiumPrediction.Exception import InsuranceException
from threading import Thread
from typing import List

from multiprocessing import Process
from InsurancePremiumPrediction.entity.artifact_entity import ModelPusherArtifact, DataIngestionArtifact, ModelEvaluationArtifact
from InsurancePremiumPrediction.entity.artifact_entity import DataValidationArtifact, DataTransformationArtifact, ModelTrainerArtifact
...
from datetime import datetime
import pandas as pd
from InsurancePremiumPrediction.constant import EXPERIMENT_DIR_NAME, EXPERIMENT_FILE_NAME
...
class Pipeline(Thread):
    ...
    def start_data_ingestion(self) -> DataIngestionArtifact:
        try:
            data_ingestion = DataIngestion(data_ingestion_config=self.config.get_data_ingested_config())
